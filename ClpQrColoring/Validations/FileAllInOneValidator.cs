...
namespace ClpQrColoring.Validations
{
    ...
    public class FileAllInOneValidator
        : ValidationAttribute, IClientValidatable
    {
        ...
        private FileTypeValidator _validFileTypeValidator;

        /// <param name="validFileTypes">Valid file extentions(without the dot)</param> 
        public FileAllInOneValidator(params string[] validFileTypes)
            : base()
        {
            _validFileTypeValidator = new FileTypeValidator(validFileTypes);
        }

        /// <param name="maximumFileSize">Maximum file size in MB</param> 
        /// <param name="validFileTypes">Valid file extentions(without the dot)</param> 
        public FileAllInOneValidator(double maximumFileSize
        ...
        /// <param name="maximumFileSize">Maximum file size in MB</param> 
        /// <param name="validFileTypes">Valid file extentions(without the dot)</param> 
        public FileAllInOneValidator(double minimumFileSize
            ...
            , ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                return (String.IsNullOrEmpty(errorMessage.ToString())) ?
                    ValidationResult.Success : new ValidationResult(errorMessage.ToString());
            }
            ...
            , ControllerContext context)
        {
            ...
            List<string> clientvalidationmethods = new List<string>();
