...
function showModalStatic(modalId) {
    // this clears the BS modal data
...
/* end of showing/hiding Bootstrap modals */


/* showing/hiding items */

function hideItem(itemId) {
    $('#' + itemId).addClass('displayNone');
    $('#' + itemId).removeClass('displayBlock');
}

function showItem(itemId) {
    $('#' + itemId).addClass('displayBlock');
    $('#' + itemId).removeClass('displayNone');
}

/* end of showing/hiding items */
...
/* end of detecting mobile browsers */
...
function enableNavigateAwayPrompt() {
    window.onbeforeunload = function () {
        return true;
    }
}

function disableNavigateAwayPrompt() {
    window.onbeforeunload = null;
}

/* end of navigate away prompt */